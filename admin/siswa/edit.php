              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    placeholder="Masukkan NIS" name="nis"  value="<?php echo $e['nis'];?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    placeholder="Masukkan Nama Siswa" name="nama"  value="<?php echo $e['nama'];?>">
                  </div>
                </div>
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    placeholder="Masukkan Alamat" name="alamat"  value="<?php echo $e['alamat'];?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    placeholder="Masukkan Nomor Telepon" name="no_telp"  value="<?php echo $e['no_telp'];?>">
                  </div>
                </div>
                <div class="form-group">
