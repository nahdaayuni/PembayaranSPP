            ...
            <form class="form-horizontal" method="post" action="?petugas=update">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="id_petugas" placeholder="Masukkan Id Petugas" name="id_petugasdisabled"  
              ...
              <div class="box-footer">
                <a class="btn btn-default" href="?petugas=read" >Cancel</a>
