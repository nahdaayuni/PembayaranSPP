...
<?php $biodataSiswa = mysqli_query($con, "SELECT * FROM siswa 
                    JOIN kelas ON siswa.id_kelas=kelas.id_kelas 
                    WHERE nisn='$nisn'"); 
                 $r_siswa = mysqli_fetch_assoc($biodataSiswa);   ?>
...
<div  align="center">
   <a href="pembayaran/print.php?nisn=<?=$r_siswa['nisn']?>" target="_blank" class="btn btn-danger btn-sm"><b>CETAK PDF</b></a>      
</div>
</br>
<?php } ?>
