...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="https://img.freepik.com/free-vector/man-avatar-profile-round-icon_24640-14044.jpg?size=338&ext=jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=$_SESSION['nama_petugas']?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="https://img.freepik.com/free-vector/man-avatar-profile-round-icon_24640-14044.jpg?size=338&ext=jpg" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                  <a href="logout.php" class="btn btn-default btn-block btn-flat">Logout</a>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="?siswa=read"><i class="fa fa-circle-o"></i> Data Siswa</a></li>
            <li><a href="?kelas=read"><i class="fa fa-circle-o"></i> Data Kelas</a></li>
            <li><a href="?petugas=read"><i class="fa fa-circle-o"></i> Data Petugas</a></li>
            <li><a href="?pembayaran=read"><i class="fa fa-circle-o"></i> Data Pembayaran</a></li>
            <li><a href="?spp=read"><i class="fa fa-circle-o"></i> Data SPP</a></li>
          </ul>
        </li>
        <li class="active treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="?pembayaran=history"><i class="fa fa-circle-o"></i> History Pembayaran </a></li>
            <!-- <li><a href="?pembayaran=cetak"><i class="fa fa-circle-o"></i> Cetak History Pembayaran</a></li> -->
          </ul>
        </li>
           <li class="treview menu active">
            <a href="logout.php">
            <i class="fa fa-share"></i> <span>Logout</span></i>
          </a>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Menu<small>Pembayaran SPP</small>
      </h1>
