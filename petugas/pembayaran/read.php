...
?>
 ...
 <td class="align-middle text-center text-m">
                          ...
                          <?php } else { ?>
                              <span class="badge badge-m bg-gradient-danger">BELUM LUNAS</span> 
                      </td>
                        <td><a href="?pembayaran=edit&id_pembayaran=<?php echo $data['id_pembayaran'];?>" class="btn btn-warning btn-xs">Edit</a> 
                      <?php } ?>
                </tr>
                <?php } ?>
              </table>
